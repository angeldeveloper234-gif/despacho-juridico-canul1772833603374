...
export function Roadmap() {
    ...
    return (
        <section className="py-24 bg-[#0F1216] relative overflow-hidden">
            <div className="container mx-auto px-6">
                <div className="text-center mb-20">
                    <p className="text-[#D4AF37] font-sans text-xs tracking-[0.4em] uppercase font-bold mb-4">
                        El Camino a su Tranquilidad
                    </p>
                    <h2 className="text-4xl md:text-6xl font-display text-white">
                        Hoja de Ruta <span className="text-[#D4AF37] italic">Estratégica</span>
                    </h2>
                </div>
                ...
                <div className="relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 relative z-10">
                        {roadmap.map((item: any, index: number) => (
                            ...
                            >
                                <div className="bg-zinc-950 border border-white/10 p-10 rounded-2xl hover:border-[#D4AF37]/30 transition-all duration-500 overflow-hidden">
                                    {/* Number Watermark */}
                                    <div className="absolute -top-4 -right-4 text-9xl font-display font-bold text-white/[0.03] pointer-events-none group-hover:text-[#D4AF37]/[0.05] transition-colors">
                                        {item.step}
                                    </div>

                                    <div className="relative z-10">
                                        <div className="w-16 h-16 rounded-2xl bg-white/5 flex items-center justify-center mb-8 group-hover:bg-[#D4AF37]/10 transition-colors">
                                            {icons[index]}
                                        </div>

                                        <div className="flex items-center gap-3 mb-4">
                                            <span className="text-[#D4AF37] font-mono text-xs font-bold tracking-widest uppercase">Paso {item.step}</span>
