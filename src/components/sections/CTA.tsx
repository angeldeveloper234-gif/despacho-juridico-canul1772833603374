    ...
    return (
        <section className="py-32 bg-[#0F1216] text-white relative overflow-hidden border-t border-white/5">
            ...
            <div className="container mx-auto px-6 text-center relative z-10">
                ...
                >
                    <ShieldCheck size={48} className="mx-auto mb-8 text-[#D4AF37] opacity-50" />

                    <h2 className="text-5xl md:text-8xl font-display mb-10 leading-[0.9] tracking-tighter">
                        ¿Su patrimonio requiere una <span className="text-[#D4AF37] italic underline decoration-1 underline-offset-8">Defensa de Élite?</span>
                    </h2>
                    ...
                    <div className="flex flex-col items-center gap-8">
                        <Button
                            size="lg"
                            className="h-20 px-12 bg-white text-black hover:bg-[#D4AF37] hover:text-white rounded-none text-sm tracking-[0.3em] uppercase font-bold transition-all duration-500 shadow-2xl"
