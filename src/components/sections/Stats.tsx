...
export function Stats() {
    ...
    return (
        <section className="py-24 bg-[#0F1216] border-y border-white/5 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    {data.map((item, index) => (
                        <motion.div
                            ...
                            className="text-center md:text-left border-l border-[#D4AF37]/20 pl-8"
                        >
                            ...
                            <div className="flex bg-gradient-to-tr from-white to-zinc-500 bg-clip-text text-transparent">
                                ...
                                <span className="text-4xl md:text-5xl font-display font-medium text-[#D4AF37] mt-2 ml-1">
                                    {item.suffix}
                                </span>
                            </div>
                        </motion.div>
